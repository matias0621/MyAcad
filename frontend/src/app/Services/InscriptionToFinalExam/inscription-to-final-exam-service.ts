...
export class InscriptionToFinalExamService {
  ...
  getInscriptionByDateInscription(inscriptionDate:string){
    return this.http.get<InscriptionToFinalExam[]>(`${this.api_url}/date-inscription/${inscriptionDate}`)
  }

  getInscriptionByDateExam(examDate:string){
    return this.http.get<PostInscriptionToFinalExam[]>(`${this.api_url}/date-inscription/${examDate}`)
  }
  ...
  addStudentToFinalExam(idInscription:number, idSubjects:number){
    return this.http.put(`${this.api_url}/${idInscription}`, idSubjects)
  }
